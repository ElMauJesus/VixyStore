...
export const INITIAL_TARIFAS_CONFIG: TarifasDeliveryConfig = {
  ...
  porcentajeComisionDelivery: 15, // 15% Comisión de servicio para la empresa por delivery (editable en backend)
  porcentajeComisionComercio: 15, // 15% Comisión de la empresa sobre ventas de comercios (editable en backend)
  ...
  fechaActualizacion: '2026-09-06 12:00:00'
};
...
export const INITIAL_ORDERS: Pedido[] = [
  {
    ...
    referenciaPago: 'WALLET-VIXY-8047',
    comprobantePagoUrl: '/uploads/comprobantes_pago/recibos/debito_cli_004_VIX-8047.jpg',
    notificacionMetodoPago: {
      tipo: 'wallet',
      metodo: 'saldo_cartera',
      descripcion: 'Cartera Vixy prepagada',
      referencia: 'WALLET-VIXY-8047',
    ...
    tiempoRestanteAceptarComercio: 60,
  ...
  },
  {
    ...
    estado: 'entregado',
    creadoEn: new Date().toISOString().slice(0, 10) + ' 10:15:00',
    actualizadoEn: new Date().toISOString().slice(0, 10) + ' 10:45:00',
  ...
  },
  {
    ...
    comprobantePagoUrl: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=500&auto=format&fit=crop&q=80',
    estado: 'esperando_repartidor',
    tiempoRestanteAceptarConductor: 15,
    conductorOfrecidoId: 'cond-001',
    conductoresRechazaron: [],
  ...
  },
  {
    ...
    comprobantePagoUrl: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=500&auto=format&fit=crop&q=80',
    estado: 'entregado',
    creadoEn: new Date(Date.now() - 86400000 * 2).toISOString().slice(0, 10) + ' 14:20:00',
    actualizadoEn: new Date(Date.now() - 86400000 * 2).toISOString().slice(0, 10) + ' 15:05:00',
    tiempoEstimadoRestanteSegundos: 0,
    esPedidoTienda: true,
    origenPedido: 'tienda_independiente',
    solicitadoPor: 'comercio',
...
// LIQUIDACIONES Y RETIROS APROBADOS DE COMERCIOS
export const INITIAL_LIQUIDACIONES_COMERCIOS: LiquidacionComercio[] = [
  {
    id: 'liq-com-101',
    comercioId: 'com-001',
    comercioNombre: 'Burger House Caracas',
    montoBrutoUsd: 120.00,
    comisionEmpresaUsd: 18.00, // 15% Comisión de la empresa separada automáticamente
    montoNetoUsd: 102.00, // Pagado al comercio
    montoNetoBs: 8007.00,
    tasaBcv: 78.50,
    metodoPago: 'pago_movil',
    bancoDestino: 'Banesco (0134)',
    cuentaTelefonoDestino: '0414-9988221',
    referenciaBancaria: 'REF-BN-98214402',
    comprobanteUrl: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80',
    comprobanteRutaSql: '/uploads/comprobantes_liquidaciones/liq_com_101.png',
    estado: 'procesado',
    autorizadoPor: 'vixydely (Super Admin)',
    notas: 'Liquidación periódica semanal de ventas brutas menos 15% comisión Vixy.',
    fecha: '2026-09-04 15:30:00'
  },
  {
    id: 'liq-com-102',
    comercioId: 'com-002',
    comercioNombre: 'Pizzería Napoli Chacao',
    montoBrutoUsd: 85.00,
    comisionEmpresaUsd: 12.75, // 15%
    montoNetoUsd: 72.25,
    montoNetoBs: 5671.62,
    tasaBcv: 78.50,
    metodoPago: 'transferencia_bancaria',
    bancoDestino: 'Banco Mercantil (0105)',
    cuentaTelefonoDestino: '0105-0021-99-1234567890',
    referenciaBancaria: 'REF-MER-77182910',
    comprobanteUrl: 'https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=600&auto=format&fit=crop&q=80',
    comprobanteRutaSql: '/uploads/comprobantes_liquidaciones/liq_com_102.png',
    estado: 'procesado',
    autorizadoPor: 'vixydely (Super Admin)',
    notas: 'Liquidación de órdenes de fin de semana transferida con éxito.',
    fecha: '2026-09-05 11:20:00'
  }
];

// LIQUIDACIONES Y PAGOS DE INGRESOS A REPARTIDORES
export const INITIAL_LIQUIDACIONES_CONDUCTORES: LiquidacionConductor[] = [
  {
    id: 'liq-cond-201',
    conductorId: 'cond-001',
    conductorNombre: 'Carlos Ramírez',
    montoBrutoUsd: 45.00,
    comisionEmpresaUsd: 6.75, // 15% Descuento de comisión de empresa
    montoNetoUsd: 38.25, // Enviado al motorizado
    montoNetoBs: 3002.62,
    tasaBcv: 78.50,
    carrerasLiquidadas: 15,
    metodoPago: 'pago_movil',
    bancoDestino: 'Banco de Venezuela (0102)',
    cuentaTelefonoDestino: '0414-2233445 (V-24891023)',
    referenciaBancaria: 'BDV-PM-55192834',
    comprobanteUrl: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80',
    comprobanteRutaSql: '/uploads/comprobantes_liquidaciones/liq_cond_201.png',
    estado: 'procesado',
    autorizadoPor: 'vixydely (Super Admin)',
    notas: 'Pago de ganancias netas por carreras completadas con descuento de 15% de comisión.',
    fecha: '2026-09-04 18:00:00'
  }
];

// SOLICITUDES DE REGISTRO DIRECTO DE CONDUCTORES (PENDIENTES DE APROBACIÓN)
export const INITIAL_SOLICITUDES_CONDUCTORES: SolicitudRegistroConductor[] = [
  {
    id: 'sol-cond-001',
    nombre: 'Alejandro',
    apellido: 'Gómez',
    ...
    placaMoto: 'AB9X44D',
    marcaMoto: 'Empire Keeway',
    modeloMoto: 'Horse 150',
    anoMoto: '2023',
    colorMoto: 'Azul',
    licenciaGrado: '2da (Motos)',
    licenciaVencimiento: '2027-11-20',
    certificadoMedicoVencimiento: '2026-08-15',
    fotoCedulaUrl: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    fotoLicenciaUrl: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    fotoCertificadoMedicoUrl: 'https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?w=600&auto=format&fit=crop&q=80',
    fotoCarnetCirculacionUrl: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80',
    ...
    fechaSolicitud: '2026-09-06 09:15:00'
  }
];
