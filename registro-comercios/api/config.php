...
define('DELIVERY_DB_NAME', getenv('DELIVERY_DB_NAME') ?: 'c2861522_vixy_dl');
...
/**
 * Conexión PDO a c2861522_vixy_dl
 */
function getDeliveryDbConnection() {
    $dsn = "mysql:host=" . REGIST_DB_HOST . ";port=" . REGIST_DB_PORT . ";dbname=" . DELIVERY_DB_NAME . ";charset=utf8mb4";
    ...
    try {
        ...
        error_log("Error de conexión a c2861522_vixy_dl: " . $e->getMessage());
        return null;
    }
}
