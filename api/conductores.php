...
if ($method === 'GET') {
    ...
    $sql = "SELECT id, nombre, apellido, cedula, telefono, email, foto_url, disponible, en_carrera,
                   latitud_actual, longitud_actual, saldo_billetera_usd, bloqueado_por_saldo,
    ...
    foreach ($drivers as &$driver) {
        $driver['latitud_actual'] = isset($driver['latitud_actual']) ? (float)$driver['latitud_actual'] : 0.0;
        $driver['longitud_actual'] = isset($driver['longitud_actual']) ? (float)$driver['longitud_actual'] : 0.0;
        $driver['disponible'] = (bool)$driver['disponible'];
        $driver['en_carrera'] = (bool)$driver['en_carrera'];
        $driver['bloqueado_por_saldo'] = (bool)$driver['bloqueado_por_saldo'];
