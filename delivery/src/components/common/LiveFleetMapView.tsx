...
export const LiveFleetMapView: React.FC = () => {
  ...
  const filteredDrivers = allDrivers.filter(driver => {
    ...
    const dUbi = (driver.ubicacionActual || '').toLowerCase();

    const matchesSearch = !term || dNom.includes(term) || dApe.includes(term) || dPlaca.includes(term) || dMod.includes(term) || dUbi.includes(term);
                      ...
                      <div className="flex items-center gap-2.5 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-slate-400 font-mono">
                            C.I: {drv.legal?.cedula || drv.cedula || 'N/A'}
                          </p>
                        </div>
                      </div>
