        ...
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] text-neutral-400 font-mono truncate">
              {(driver.moto?.marca || 'Moto')} • Placa: {(driver.moto?.placa || 'S/P')}
            </p>
          </div>
        </div>
        ...
        {activeTab === 'ficha_legal' && (
          <div className="p-3.5 bg-white dark:bg-neutral-850 rounded-2xl border border-neutral-200 dark:border-neutral-800 space-y-3.5 text-xs">
            ...
            <div className="p-2.5 rounded-xl bg-neutral-100 dark:bg-neutral-800 space-y-1">
              ...
              <p><strong>Cédula de Identidad:</strong> {driver.legal?.cedula || driver.cedula || 'N/A'}</p>
            ...
            <div className="p-2.5 rounded-xl bg-neutral-100 dark:bg-neutral-800 space-y-1">
              ...
              <p><strong>Marca y Modelo:</strong> {driver.moto?.marca || 'Bera'} {driver.moto?.modelo || 'SBR'} ({driver.moto?.ano || 2024})</p>
              <p><strong>Color:</strong> {driver.moto?.color || 'Negro'}</p>
              <p className="text-amber-500 font-bold font-mono"><strong>Placa INTT:</strong> {driver.moto?.placa || 'S/P'}</p>
              <p className="font-mono text-[11px]"><strong>Serial Motor:</strong> {driver.moto?.serialMotor || 'S/N'}</p>
              <p className="font-mono text-[11px]"><strong>Serial Chasis:</strong> {driver.moto?.serialChasis || 'S/N'}</p>
            </div>
            ...
            <div className="p-2.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-[11px] space-y-1 text-emerald-800 dark:text-emerald-300">
              ...
              <p>✓ Licencia Grado: {driver.legal?.licenciaGrado || '2da'} (Motos) - N° {driver.legal?.licenciaNumero || 'S/N'}</p>
