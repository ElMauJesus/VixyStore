          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="p-2.5 rounded-xl bg-neutral-50 dark:bg-neutral-850 border border-neutral-200 dark:border-neutral-800">
              ...
              <span className="font-mono font-bold text-neutral-900 dark:text-white">
                {(typeof store.horarios === 'object' ? (store.horarios as any)?.lunesASabado : store.horarios) || '11:00 AM - 10:30 PM'}
              </span>
            </div>
            <div className="p-2.5 rounded-xl bg-neutral-50 dark:bg-neutral-850 border border-neutral-200 dark:border-neutral-800">
              <span className="text-[10px] uppercase font-bold text-neutral-400 block">Domingos & Feriados</span>
              <span className="font-mono font-bold text-neutral-900 dark:text-white">
                {(typeof store.horarios === 'object' ? (store.horarios as any)?.domingos : null) || '12:00 PM - 09:30 PM'}
              </span>
            </div>
          </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-0.5 text-purple-500">
                      ...
                      <span className="font-mono font-bold text-[10px]">{(res as any).estrellas || res.calificacion}</span>
                    </div>
                  </div>
