  ...
  return (
    <div className={`flex flex-col items-center shrink-0 ${width} max-w-full`}>
      ...
      <div className="w-full h-[690px] bg-[#0F172A] rounded-[40px] p-3 shadow-2xl border-4 border-slate-800 ring-1 ring-slate-700/50 flex flex-col relative overflow-hidden">
        ...
        <div className="absolute top-4 left-1/2 -translate-x-1/2 w-28 h-5 bg-slate-950 rounded-full z-40 flex items-center justify-end px-3 pointer-events-none">
          <div className="w-2 h-2 rounded-full bg-slate-800 border border-slate-700" />
        </div>

        {/* Screen Status Bar */}
        <div className="h-7 w-full px-5 flex items-center justify-between text-[11px] text-slate-400 z-30 shrink-0 font-medium select-none pointer-events-none">
          <span>12:45</span>
