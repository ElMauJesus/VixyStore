...
export const BACKEND_FILES: BackendFile[] = [
  {
    path: 'sql/acreditaciones_custodia_y_reportes_financieros.sql',
    name: 'acreditaciones_custodia_y_reportes_financieros.sql',
    folder: 'sql',
    language: 'sql',
    description: 'Motor SQL de Acreditaciones de Custodia en Wallet, Moneda Dual ($ y Bs con Tasa BCV), Vistas por Día/Semana/Mes y Trigger de Liquidación Automática',
    content: `-- =============================================================================
...
-- Vistas de Agrupación Temporal (Día, Semana, Mes) y Sincronización de 5 Segundos
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS \`acreditaciones_custodia_wallet\` (
    ...
    \`estado_wallet\` ENUM('acreditado', 'retenido_custodia', 'liquidado_banco') NOT NULL DEFAULT 'acreditado',
